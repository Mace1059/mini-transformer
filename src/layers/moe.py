...
from src.layers.utils import moe_load_balancing_loss, TopExpertsRouter
from src.config import n_experts, top_k_experts
# ========================================
#               Normal MOE
# ========================================
...
class MoEFeedForward(nn.Module):
    def __init__(self, d_model, ffn_mult, dropout):
        ...
        self.top_experts = top_k_experts
        self.router = TopExpertsRouter(d_model, n_experts, top_experts=top_k_experts)
